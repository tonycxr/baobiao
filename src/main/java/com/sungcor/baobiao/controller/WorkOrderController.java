...
//                            Map processStatus = processStatusService.getAll(Util.getRootPath()+"/conf/bpm");//生成状态Map
                            ...
                            for(BusinessOpt opt:opts){
                                ...
                                else if("singin".equals(opt.getOptType())){  log.put("optContent", "签收");
                                }
                                else if("refuse".equals(opt.getOptType())){ log.put("optContent","拒绝");
                                }
                                else if("deal".equals(opt.getOptType())){ log.put("optContent","处理");
                                }
                                else if("audit".equals(opt.getOptType())){ log.put("optContent","审批");
                                }
                                else if("confirm".equals(opt.getOptType())){ log.put("optContent","关闭");
                                }
                                else if("retake".equals(opt.getOptType())){ log.put("optContent","取回");
                                }
                                else if("terminate".equals(opt.getOptType())){ log.put("optContent","中止");
                                }
                                else if("decision".equals(opt.getOptType())){ log.put("optContent","提交决策");
                                }
                                else if("review".equals(opt.getOptType())){ log.put("optContent","多人处理");
                                }else{log.put("optContent",opt.getOptType());}
                                logList.add(log);
                            }
                            //评价信息设置
